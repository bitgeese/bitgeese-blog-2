...
import logoSherpa from '@/images/logos/leadsherpa.png'
import logoGcore from '@/images/logos/gcore.jpeg'
...
function Newsletter() {
  return (
    <form
      action="https://form-submit.maciej-janowski1.workers.dev" 
      method='POST'
    ...
    >
      ...
      <div className="mt-6 flex">
        <input
          ...
          required
          name="email"
          className="min-w-0 flex-auto appearance-none rounded-md border border-slate-900/10 bg-white px-3 py-[calc(theme(spacing.2)-1px)] shadow-md shadow-slate-800/5 placeholder:text-slate-400 focus:border-primary-500 focus:outline-none focus:ring-4 focus:ring-primary-500/10 sm:text-sm dark:border-slate-700 dark:bg-slate-700/[0.15] dark:text-slate-200 dark:placeholder:text-slate-500 dark:focus:border-primary-400 dark:focus:ring-primary-400/10"
        />
...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-slate-100 p-6 dark:border-slate-700/40">
      ...
      <Button href="/MJanowski_resume_2024.pdf" variant="secondary" className="group mt-6 w-full">
        Download CV
